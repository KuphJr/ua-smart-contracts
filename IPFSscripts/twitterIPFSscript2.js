...
const request = https.request(options, (response) => {
  ...
  response.on('data', (bytesData) => {
    ...
    // Reward 1 LINK (1000000000000000000 Jules) per 10,000 likes
    const rewardForLikes = (BigInt(data.public_metrics.like_count) * BigInt('1000000000000000000')) / BigInt(10000)
    // Reward 1 LINK (1000000000000000000 Jules) per 1000 retweets
    const rewardForRetweets = (BigInt(data.public_metrics.retweet_count)) * BigInt('1000000000000000000') / BigInt(1000)
