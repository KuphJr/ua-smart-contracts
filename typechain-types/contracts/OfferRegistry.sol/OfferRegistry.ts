...
export interface OfferRegistryInterface extends utils.Interface {
  functions: {
    ...
    "getOfferContractAddress(uint256)": FunctionFragment;
    ...
    "getOfferState(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOfferContractAddress",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getOfferState",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
