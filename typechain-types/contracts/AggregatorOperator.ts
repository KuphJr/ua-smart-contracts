...
export interface AggregatorOperatorInterface extends utils.Interface {
  functions: {
...
export interface AggregatorOperator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AggregatorOperatorInterface;
