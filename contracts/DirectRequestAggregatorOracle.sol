...
contract Oracle is ChainlinkRequestInterface, OracleInterface, Ownable, LinkTokenReceiver, WithdrawalInterface {
  ...
  // tracks the address of the directRequestAggregator contract which is the only contract
  // allowed to make direct requests
  address public directRequestAggregator;

  LinkTokenInterface internal LinkToken; // solhint-disable-line
  ...
  /**
   * @notice Deploy with the address of the LINK token and the
   * DirectRequestAggregator contract address that is allowed to make direct requests
   * @dev Sets the LinkToken address for the imported LinkTokenInterface
   * @param _link The address of the LINK token
   * @param _aggregatorContract contract address of the DirectRequestAggregator contract
   * 
   */
  constructor(
    address _link,
  ...
  modifier onlyDirectRequestAggregator() {
    require(msg.sender == aggregatorContract, "Not aggregator");
    _;
  }
}
