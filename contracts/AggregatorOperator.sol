 ...
 */
contract AggregatorOperator is AuthorizedReceiver, ConfirmedOwner, LinkTokenReceiver, OperatorInterface, WithdrawalInterface {
  ...
  function setAggregatorContract(address _aggregatorContract)
  external onlyOwner {
  ...
  function oracleRequest(
    ...
    require(sender == aggregatorContract, "Not aggregator");
